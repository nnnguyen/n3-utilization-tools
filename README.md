...
| `BOOTSTRAP_SUPER_ADMIN_EMAIL` | no | Email of the first system admin: that account becomes super admin at startup or at its next sign-in, **only while no super admin exists**. Afterwards super admins are granted/revoked on the Admin page |
