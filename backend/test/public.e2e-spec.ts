...
describe("Public topics (e2e)", () => {
  ...
  it("rejects submissions to a question that is not ACTIVE (409)", async () => {
    await request(app.getHttpServer())
      ...
      .send({
        text: "hello",
        participantSessionId: "22222222-2222-4222-8222-222222222222",
      })
      .expect(409);
  });
  ...
  it("rejects text that normalizes to empty (400)", async () => {
    await request(app.getHttpServer())
      ...
      .send({
        text: "!!!",
        participantSessionId: "33333333-3333-4333-8333-333333333333",
      })
      .expect(400);
  });
  ...
  it("accepts submissions from different participants and merges case-different duplicates into one WordAggregate", async () => {
    const first = await request(app.getHttpServer())
      ...
      .send({
        text: "Xin",
        participantSessionId: "44444444-4444-4444-8444-444444444444",
      })
      .expect(201);
    ...
    const second = await request(app.getHttpServer())
      ...
      .send({
        text: "xin",
        participantSessionId: "99999999-9999-4999-8999-999999999999",
      })
      .expect(201);
