...
| **P2-3** | Google Drive | Tự sao lưu MP4/M4A/transcript sau khi sync | Cần thêm quyền Drive → người dùng phải uỷ quyền Google lại; cấu trúc thư mục · **Bản nháp thiết kế (26/09/2026, chờ duyệt)**: [docs/design/P2-3-google-drive.md](design/P2-3-google-drive.md) |
| **P2-4** | Google Calendar | Xem lịch họp sắp tới, gắn link video vào sự kiện | Lịch nào (cá nhân hay lịch chung của nhóm) · **Bản nháp thiết kế (26/09/2026, chờ duyệt)**: [docs/design/P2-4-google-calendar.md](design/P2-4-google-calendar.md) — phần xem buổi họp sắp tới lấy từ Zoom, không cần quyền Google |
...
| **P2-6** | Zalo OA | Thông báo qua Zalo trên khung P2-1 | Có sẵn OA đã xác thực chưa · **Bản nháp thiết kế (26/09/2026, chờ duyệt)**: [docs/design/P2-6-zalo-oa.md](design/P2-6-zalo-oa.md) — cần chốt gửi cho ai (người vận hành hay cộng đồng) |
