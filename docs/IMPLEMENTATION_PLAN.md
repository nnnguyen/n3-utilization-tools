...
| **P2-3** | Google Drive | Tự sao lưu MP4/M4A/transcript sau khi sync | Cần thêm quyền Drive → người dùng phải uỷ quyền Google lại; cấu trúc thư mục · **Bản nháp thiết kế (26/09/2026, chờ duyệt)**: [docs/design/P2-3-google-drive.md](design/P2-3-google-drive.md) · **Góp ý 27/09/2026**: người dùng tự chọn có lưu vào Drive hay không (mặc định tắt, chọn được từng recording); file giữ riêng tư |
| **P2-4** | Buổi họp sắp tới | Xem các buổi họp Zoom sắp tới và quy tắc sẽ áp dụng (lấy từ Zoom, không cần quyền Google) | **Góp ý 27/09/2026**: bỏ phần tự gắn video vào Google Calendar — chỉ super admin quyết định chia sẻ video/recording hay không và cho ai. **Bản nháp thiết kế (chờ duyệt)**: [docs/design/P2-4-upcoming-meetings.md](design/P2-4-upcoming-meetings.md), task P2-4a |
...
| **P2-6** | Zalo OA | Thông báo qua Zalo trên khung P2-1 | Có sẵn OA đã xác thực chưa · **Bản nháp thiết kế (26/09/2026, chờ duyệt)**: [docs/design/P2-6-zalo-oa.md](design/P2-6-zalo-oa.md) — cần chốt gửi cho ai (người vận hành hay cộng đồng) · **Góp ý 27/09/2026**: super admin duyệt từng tin, không gửi tự động |
