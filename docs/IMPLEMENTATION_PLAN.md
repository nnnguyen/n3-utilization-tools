...
| **P2-2** | Workspace và phân quyền | Kết nối Zoom/YouTube thuộc về một nhóm; vai trò Quản trị / Biên tập / Xem; nhật ký hoạt động | **Đã chốt (25/09/2026)**: nhiều workspace/người; không gộp tự động; giữ tự đăng ký + super admin toàn quyền (tạo tài khoản thủ công, mật khẩu tạm gửi email); email qua Resend. Thiết kế: [docs/design/P2-2-workspaces.md](design/P2-2-workspaces.md), task con P2-2a → P2-2i |
