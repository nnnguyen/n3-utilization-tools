...
**P2-2h1 — Super admin, account level (done early, 2026-09-26).** The account part of P2-2h below, built before workspaces: `platformRole`, lock, temp passwords, must-change gate, `ActivityLog` with a nullable `workspaceId`, Admin → Accounts / Activity. First super admin: `gerald.nnnguyen@gmail.com` via `BOOTSTRAP_SUPER_ADMIN_EMAIL`.
